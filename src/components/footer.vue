 <template>
  ...
  <div class="container px-6 pt-6">
    <div class="flex justify-center mb-6">
      ...
      <a href="https://www.linkedin.com/in/evalyne-mulandi-3934b622b/" type="button" class="rounded-full border-2 border-white text-white leading-normal uppercase hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out w-9 h-9 m-1">
        <svg aria-hidden="true"
        focusable="false"
        data-prefix="fab"
